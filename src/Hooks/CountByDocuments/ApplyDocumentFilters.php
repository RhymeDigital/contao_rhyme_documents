...
namespace Rhyme\ContaoDocumentsBundle\Hooks\CountByDocuments;
 ...
 * @package Rhyme\ContaoDocumentsBundle\Hooks\CountByDocuments
 */
class ApplyDocumentFilters extends \Frontend
{
     ...
     * Class:		DocumentModel
     * Method:		countBy
     * Hook:		$GLOBALS['TL_HOOKS']['countByDocuments']
     *
     * @access		public
     * @param		array
     * @param		string
