...
(
	...
	'exclude'                 => true,
	'inputType'               => 'checkbox',
	'options_callback'        => array('Rhyme\ContaoDocumentsBundle\Backend\Module\Document\Callbacks', 'getDocumentArchives'),
...
(
	...
	'exclude'                 => true,
	'inputType'               => 'select',
	'options_callback'        => array('Rhyme\ContaoDocumentsBundle\Backend\Module\Document\Callbacks', 'getReaderModules'),
	'reference'               => &$GLOBALS['TL_LANG']['tl_module'],
...
(
	...
	'wizard' => array
	(
		array('Rhyme\ContaoDocumentsBundle\Backend\Module\Document\Callbacks', 'hideStartDay')
	),
	'sql'                     => "varchar(32) NOT NULL default ''"
);
...
(
    ...
    'options_callback'        => array('Rhyme\ContaoDocumentsBundle\Backend\Module\Document\Callbacks', 'getDocumentFilterFields'),
    'eval'                    => array('multiple'=>true, 'mandatory'=>true),
    'sql'                     => "blob NULL"
);
...
(
    ...
    'exclude'                 => true,
    'inputType'               => 'checkboxWizard',
    'options_callback'        => array('Rhyme\ContaoDocumentsBundle\Backend\Module\Document\Callbacks', 'getDocumentListModules'),
    'eval'                    => array('multiple'=>true, 'mandatory'=>true),
    'sql'                     => "blob NULL"
);
